...
class AuthersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auther" do
    assert_difference('Auther.count') do
      post authers_url, params: { auther: { email: @auther.email, password: @auther.password, password_confirmation: @auther.password_confirmation, username: @auther.username } }
    end
  ...
  test "should update auther" do
    patch auther_url(@auther), params: { auther: { email: @auther.email, password: @auther.password, password_confirmation: @auther.password_confirmation, username: @auther.username } }
